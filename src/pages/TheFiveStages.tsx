...
import unhookIdentityImage from "@/assets/unhook-identity.png.asset.json";
import reclaimValueImage from "@/assets/reclaim-value.png.asset.json";
import discoverPurposeImage from "@/assets/discover-purpose.png.asset.json";
import becomeAiReadyImage from "@/assets/become-ai-ready.png.asset.json";
import relaunchYourselfImage from "@/assets/relaunch-yourself.png.asset.json";
...
const stages = [
  {
    ...
    color: "indigo",
    image: unhookIdentityImage.url,
    imageAlt: "A thoughtful woman looking away through vivid colored light",
  ...
  },
  {
    ...
    color: "aqua",
    image: reclaimValueImage.url,
    imageAlt: "A man reflecting and writing at a creative worktable",
  ...
  },
  {
    ...
    color: "orchid",
    image: discoverPurposeImage.url,
    imageAlt: "A woman considering her next idea in a colorful creative studio",
  ...
  },
  {
    ...
    color: "citrus",
    image: becomeAiReadyImage.url,
    imageAlt: "A man exploring digital work through luminous colored reflections",
  ...
  },
  {
    ...
    color: "poppy",
    image: relaunchYourselfImage.url,
    imageAlt: "A creative professional smiling with a group of collaborators",
...
const TheFiveStages = () => {
  ...
  return (
    <div className="min-h-screen bg-soft-white text-aubergine">
      ...
      {/* Page hero */}
      <section className="relative isolate flex min-h-[70vh] items-end overflow-hidden px-6 pb-16 pt-32 md:min-h-[78vh] md:pb-20">
        <img
          src={relaunchYourselfImage.url}
          alt="A creative professional surrounded by a group of collaborators"
          className="absolute inset-0 -z-20 h-full w-full object-cover object-center"
          fetchPriority="high"
        />
        <div className="absolute inset-0 -z-10 bg-aubergine/70" aria-hidden="true" />
        <div className="mx-auto w-full max-w-6xl">
          <ScrollFadeUp>
            <h1 className="max-w-4xl font-display text-soft-white text-4xl md:text-6xl leading-tight mb-5">
              The Five Stages of The Great Repurpose
            </h1>
            <p className="font-sans text-soft-white/80 text-lg md:text-xl max-w-2xl">
