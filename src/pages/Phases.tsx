      ...
      <section className="bg-navy constellation-bg pt-32 pb-20 px-6 text-center">
        <ScrollFadeUp>
          <h1 className="font-serif text-cream text-4xl md:text-5xl leading-tight mb-4">
            The Five Phases of The Great Repurpose
          </h1>
